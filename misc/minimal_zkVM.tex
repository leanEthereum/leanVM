...
\subsection{End-to-end protocol}\label{sec:verify-protocol}

The protocol below is presented as an interactive protocol; the non-interactive version uses the standard Fiat-Shamir compilation (see TODO).
