% !TeX root = ../../main.tex
\subsection{Address-preserving randomness for control products}\label{note:zk-frame-gauge}
...
\subsubsection{Where payload randomness has no effect}

In the depth-$22$ layout of \noteref{zk-gkr-second-wire}, the second push packet's child $1$ is
\[
...
\subsubsection{Jointly treat the control fingerprints}
...
\subsubsection{Avoid a base-field-sized exceptional probability}
