% !TeX root = ../../main.tex
\subsection{Hiding the bus product root with unused memory}\label{note:zk-bus-root}
...
\subsubsection{The actual memory fingerprint}
...
\subsubsection{Products mix even when a single factor does not}
...
\subsubsection{A simulator for the shared root}
