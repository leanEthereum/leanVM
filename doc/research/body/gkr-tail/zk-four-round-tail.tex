% !TeX root = ../../main.tex
\subsection{Four joint GKR rounds with a retained native invariant}\label{note:zk-four-round-tail}
...
\subsubsection{The conditional kernel supplies four coupled pairs}
...
\end{aligned}
\]
All dependence on $I$ is confined to these fixed offsets. Each of the four independent push-slope vectors therefore supplies one coupled push/pull quartic, exactly of the form treated in \noteref{zk-three-round-tail}.
...
\subsubsection{Valid cycles realize the whole affine fiber}
...
\subsubsection{Joint backward simulation}
