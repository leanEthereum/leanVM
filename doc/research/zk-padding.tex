...
\paragraph{Optional public preprocessing.} The separate branch \path{zk-bytecode-public-library.tex} closes that residual using $1024$ private occupancy bits and independent public random SET constants installed once in bytecode. Its public-seed Fourier bound retains the correlated evaluation. Outside an exceptional fraction below $2^{-160}$ of honest libraries, the first-packet/boundary view is hidden below $2^{-154}$ under the stated normalization and completion assumptions. This changes the program digest and adds an honest-setup assumption; it has not been adopted or implemented. It does not resolve deterministic padding libraries, intervening GKR, later proofs or Fiat-Shamir.
