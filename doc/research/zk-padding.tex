...
\paragraph{Beyond the coarse frontier.} \path{zk-frontier-lifting.tex} supplies twelve product-preserving directions at the next fingerprint frontier, retaining actual counts and boundary below $2^{-165}$. Full third-layer simulation still needs further fingerprint and joint refined-count arguments. Exact push/pull relations rule out extending unrestricted uniform-frontier induction to the leaves; a full-depth proof must preserve those relations or simulate only disclosed combinations.
