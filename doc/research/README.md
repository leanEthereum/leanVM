...
[body/10-wire-ledger.tex](body/10-wire-ledger.tex) inventories the current reduction and opening wire, gives the exact committed-size formula and records a size-compatible candidate. The compact Flock endpoint construction fits that profile, but a common valid padding sampler, full joint GKR and Flock simulation, and authentication remain unproved.
