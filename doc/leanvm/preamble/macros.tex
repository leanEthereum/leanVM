...
\newcommand{\zkLowHighPoly}{B^{\mathrm{low}}}
\newcommand{\zkLowSpan}{W_{\mathrm{low}}}
\newcommand{\zkLowBankError}{\delta_{\mathrm{low}}}
\newcommand{\zkLowRatio}[1]{\beta_{#1}^{\mathrm{low}}}
