...
\newcommand{\zkRangeBits}{b_{\mathrm{range}}}
...
\newcommand{\zkReuseBcTarget}[1]{C^{\mathrm{bc}}_{#1}}
\newcommand{\zkReuseBcInput}[1]{u^{\mathrm{bc}}_{#1}}
\newcommand{\zkReuseMemInput}[2]{u^{\mathrm{mem}}_{#1,#2}}
\newcommand{\zkReuseMemOutput}[2]{\widehat u^{\mathrm{mem}}_{#1,#2}}
\newcommand{\zkNormDiff}[2]{z^{\mathrm{norm}}_{#1,#2}}
\newcommand{\zkNormDelta}[1]{\delta^{\mathrm{norm}}_{#1}}
\newcommand{\zkNormH}{h_{\mathrm{norm}}}
\newcommand{\zkNormHWithout}[1]{h_{\mathrm{norm},-#1}}
\newcommand{\zkNormS}{s_{\mathrm{norm}}}
\newcommand{\zkNormPost}[2]{e^{\mathrm{norm}}_{#1,#2}}
\newcommand{\zkNormCost}[1]{n_{\mathrm{sq}}(#1)}
\newcommand{\zkNormOffset}[1]{k_{\mathrm{sq}}(#1)}
\newcommand{\zkNormCap}{Q_{\mathrm{norm}}}
\newcommand{\zkNormWidth}[1]{w^{\mathrm{bc}}_{#1}}
\newcommand{\zkNormBcRows}[1]{n^{\mathrm{bc}}_{#1}}
\newcommand{\zkNormMemRows}{n^{\mathrm{mem}}_{\mathrm{norm}}}
\newcommand{\zkNormRouter}[1]{R^{\mathrm{norm}}_{#1}}
\newcommand{\zkNormFillQuotient}{q_{\mathrm{fill}}}
\newcommand{\zkNormFillRemainder}{s_{\mathrm{fill}}}
\newcommand{\zkNormAdapters}[2]{A^{\mathrm{norm}}_{#1,#2}}
\newcommand{\zkNormAdapterTotal}{n_{\mathrm{adapter}}}
\newcommand{\zkNormColumnWidth}[2]{w^{\mathrm{norm}}_{#1,#2}}
\newcommand{\zkNormHWidth}{w^{\mathrm{norm}}_{h}}
\newcommand{\zkNormDeltaWidth}[1]{w^{\mathrm{norm}}_{\delta,#1}}
\newcommand{\zkPriorityCap}[2]{b^{\mathrm{prio}}_{#1,#2}}
\newcommand{\zkPriorityRows}[1]{n^{\mathrm{real}}_{#1}}
\newcommand{\zkLocalCountCap}[2]{L^{\mathrm{local}}_{#1,#2}}
\newcommand{\zkLocalReads}[1]{\ell^{\mathrm{local}}_{#1}}
\newcommand{\zkIndirectReads}[1]{\ell^{\mathrm{indirect}}_{#1}}
\newcommand{\zkPrefillLength}{L_{\mathrm{tile}}}
\newcommand{\zkPrefillQuotient}{q_{\mathrm{tile}}}
\newcommand{\zkPrefillRemainder}{s_{\mathrm{tile}}}
\newcommand{\zkPrefillTail}{s_{\mathrm{block}}}
\newcommand{\zkTiledCode}[1]{b_{\mathrm{tile}}(#1)}
\newcommand{\zkTiledReturnCode}[1]{j_{\mathrm{tile}}(#1)}
\newcommand{\zkExecutedRows}[1]{n^{\mathrm{exec}}_{#1}}
\newcommand{\zkInitialTotal}[1]{N^{\mathrm{init}}_{#1}}
\newcommand{\zkInitialFill}[1]{F^{\mathrm{init}}_{#1}}
\newcommand{\zkRealBc}[1]{b^{\mathrm{real}}_{#1}}
\newcommand{\zkRealDiff}[2]{z^{\mathrm{real}}_{#1,#2}}
\newcommand{\zkInitialFillCap}[1]{L^{\max}_{\mathrm{tile},#1}}
\newcommand{\zkRealFrames}{f_{\mathrm{real}}}
\newcommand{\zkVisitBound}[2]{V_{\mathrm{bc}}(#1,#2)}
\newcommand{\zkPcVisits}[1]{\nu^{\mathrm{exec}}_{#1}}
\newcommand{\zkIncWeight}[1]{a^{\mathrm{inc}}_{#1}}
\newcommand{\zkIncWeights}{\boldsymbol a^{\mathrm{inc}}}
\newcommand{\zkIncConstant}{C_{\mathrm{inc}}}
\newcommand{\zkIncGain}[2]{Q^{\mathrm{inc}}_{#1}(#2)}
\newcommand{\zkIncPrice}[1]{\lambda^{\mathrm{inc}}_{#1}}
\newcommand{\zkIncRoleRows}[1]{d^{\mathrm{inc}}_{#1}}
\newcommand{\zkIncTargetLoad}{K_{\mathrm{inc}}}
\newcommand{\zkIncEarlierLoad}{A_{\mathrm{inc}}}
\newcommand{\zkCoarseDim}{d_{\mathrm{bal}}}
\newcommand{\zkCoarseCap}{L_{\mathrm{bal}}}
\newcommand{\zkCoarseHalf}{R_{\mathrm{bal}}}
\newcommand{\zkCoarseBlocks}{m_{\mathrm{bal}}}
\newcommand{\zkCoarseRows}{n_{\mathrm{bal}}}
\newcommand{\zkCoarseWidth}{B_{\mathrm{bal}}}
\newcommand{\zkCoarseRow}[1]{v^{\mathrm{bal}}_{#1}}
\newcommand{\zkCoarseTotal}[1]{s^{\mathrm{bal}}_{#1}}
\newcommand{\zkCoarseCut}[1]{n^{\mathrm{bal}}_{#1}}
\newcommand{\zkCoarseFixed}[2]{a^{\mathrm{bal}}_{#1,#2}}
\newcommand{\zkCoarseFlow}[2]{f^{\mathrm{bal}}_{#1,#2}}
\newcommand{\zkCoarseBase}[1]{N^{\mathrm{bal}}_{#1}}
\newcommand{\zkCoarseFill}[1]{F^{\mathrm{bal}}_{#1}}
...
\newcommand{\zkCopySum}[1]{E^{\mathrm{copy}}_{#1}}
\newcommand{\zkCopyLabel}[1]{v^{\mathrm{copy}}_{#1}}
\newcommand{\zkCopyGap}{\Delta_{\mathrm{copy}}}
\newcommand{\zkCopyConstant}{C_{\mathrm{copy}}}
\newcommand{\zkBlakeTotal}{U_{\mathrm B}}
